...
export default {
    ...
    baseAppUrl: "https://packpack-iframely.fly.dev", // use "https://yourdomain.com/path" where you have Iframely in your reverse proxy
    relativeStaticUrl: "/r",
    ...
    */
    ...
    ADD_OEMBED_PARAMS: [{
        ...
        params: { // Custom query-string params object.
            ...
            access_token: `${process.env.FACEBOOK_APPID}|${process.env.FACEBOOK_APP_SECRET}`,   // The simplest way is
    ...
    */
    ...
    providerOptions: {
        ...
        tumblr: {
            consumer_key: `${process.env.TUBMLR_CONSUMER_KEY}`
        ...
        google: {
            ...
            maps_key: `${process.env.GOOGLE_MAP_KEY}`
        },
